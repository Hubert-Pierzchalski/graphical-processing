...
def double_threshhold(array, threshhold_1=85, threshhold_2=127):
    array = np.mean(array, axis=2) #"Changing" RGB values to light values
...
def contrast_enchancment(array):
    array = np.mean(array, axis=2, dtype=int) #"Changing" RGB values to light values
    ...
    show_plot(array, number_of_pixels)
    return array
